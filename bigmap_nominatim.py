...
""" bigmap_nominatim
	----------------
	What it is : 
	Class for pmx/bigmap application/script to used with OSM's Nominatim service
...
__copyright__="Copyright 2018, Pierre-Alain Dorange"
__license__="BSD"
__version__="0.4"
...
class osm_list():
	...
	def append(self,obj):
		if isinstance(obj,osm_object):
			...
			if _debug:
				print "list as %d object(s)" % len(self.list)
		else:
